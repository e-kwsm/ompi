...
#define WORDALIGNED(v) (((intptr_t) v & OPAL_CRC_WORD_MASK_) ? false : true)
...
unsigned long opal_bcopy_csum_partial(const void *source, void *destination, size_t copylen,
...
unsigned int opal_bcopy_uicsum_partial(const void *source, void *destination, size_t copylen,
...
unsigned long opal_csum_partial(const void *source, size_t csumlen, unsigned long *lastPartialLong,
                                size_t *lastPartialLength)
{
    unsigned long *src = (unsigned long *) source;
    unsigned long csum = 0;
...
unsigned int opal_uicsum_partial(const void *source, size_t csumlen, unsigned int *lastPartialInt,
                                 size_t *lastPartialLength)
{
    unsigned int *src = (unsigned int *) source;
    unsigned int csum = 0;
...
unsigned int opal_bcopy_uicrc_partial(const void *source, void *destination, size_t copylen,
...
unsigned int opal_uicrc_partial(const void *source, size_t crclen, unsigned int partial_crc)
{
    register int i, j;
    register unsigned char *t;
    unsigned int tmp;
